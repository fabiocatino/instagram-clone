...
const Modal = () => {
	...
	return (
		<Transition.Root show={open} as={Fragment}>
			...
			>
				<div
					className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4
				...
				>
					...
					>
                        ...
                        shadox-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6 "
						>
							<div>
								{selectedFile ? (
									<img
